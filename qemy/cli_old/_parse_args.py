...
ARGUMENTS = {
    ...
    'save':        lambda p: p.add_argument('-s', '--save',
                                            action='store_true'),
    'period':      lambda p: p.add_argument('-p', '--period',
                                            default='1Y'),
    'units':       lambda p: p.add_argument('-u', '--units'),
    'ticker_flag': lambda p: p.add_argument('-t', '--ticker'),
    'num':         lambda p: p.add_argument('-n', '--num',
                                            default=1000),
    'quarter':     lambda p: p.add_argument('-q', '--quarter',
                                            default='10'),
    'metric':      lambda p: p.add_argument('-m', '--metric',
                                            default='epsd'),
    'plot':        lambda p: p.add_argument('-plt', '--plot',
                                            action='store_true'),
    'help':        lambda p: p.add_argument('-h', '--help',
                                            action='store_true'),
    'request':     lambda p: p.add_argument('-r', '--request',
                                            action='store_true'),
